...
export default async function NewsArticlePage({ params }: Props) {
  ...
  return (
    ...
    <article className="bg-white rounded-lg shadow-md overflow-hidden">
        {/* Title */}
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center px-4 py-4">
            {article.title}
        </h1>

        {/* Image Section */}
        <div className="relative pt-6 pb-6 mx-auto w-full max-w-4xl">
            <Image
                src={article.image_path || "/placeholder.svg"}
                alt={article.title}
                width={800}
        ...
        <div className="py-6 px-4 sm:px-6 lg:px-8">
            ...
            {/* Description */}
            <div className="prose max-w-none mx-auto text-justify sm:text-left">
